...
## Exemple de Interacțiune cu Accesibilitate Digitală

```{python}
#| label: ai-examples
#| output: true

ai_examples_df = query_to_dataframe("""
SELECT 
    ce.nume as "Competenta",
    ce.descriere as "Exemplu Descriere",
    cc.nume as "Componenta",
    i.nume as "Tip Interacțiune"
...
""")
try:
    display(ai_examples_df.style.hide(axis='index'))
except:
    display(ai_examples_df)
```
